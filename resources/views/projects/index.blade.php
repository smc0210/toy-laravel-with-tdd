...
@section('content')
    <header class="flex items-center mb-3 py-4">
        <div class="flex justify-between items-end w-full">
            <h2 class="text-muted text-base font-light">My Project</h2>
    ...
    <modal name="hello-world" classes="p-10 bg-card rounded-lg" height="auto">
        <h1 class="font-noraml mb-16 text-center text-2xl">Let's start something new</h1>
        ...
        <div class="flex">
            <div class="flex-1 mr-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="title" class="border border-muted-light p-2 text-xs block w-full rounded" rows="7"></textarea>
                </div>
            </div>
        ...
        <footer class="flex justify-end">
            <button class="button is-outlined mr-4">Cancle</button>
